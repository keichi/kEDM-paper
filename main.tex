...
variables. Despite its wide applicability, the scale of the datasets that can
be applied to was limited because EDM is computationally expensive To overcome
this obstacle, researchers have attempted to accelerate EDM  from both
algorithmic and implementational aspects~\cite{Pu2019,Ma2014}.

We approach this challenge by taking advantage of modern HPC systems equipped
...
Currently, mpEDM has two independent backends for x86\_64 CPUs and NVIDIA
GPUs. This design becomes a burden when supporting a diverse set of hardware
platforms because a new backend needs to be developed and maintained for
every platform. Meanwhile, various performance portability
frameworks~\cite{Deakin2019, Deakin2020} have been proposed to develop
